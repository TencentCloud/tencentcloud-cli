...
def doDeleteTableIndex(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("DeleteTableIndex", g_param[OptionsDefine.Version])
        return
...
def doSetTableIndex(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("SetTableIndex", g_param[OptionsDefine.Version])
        return
