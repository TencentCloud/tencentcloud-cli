...
def doChannelCreateFlowSignReview(args, parsed_globals):
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelCreateFlowSignReviewRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelCreateFlowSignReview(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelModifyRole(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelModifyRoleRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelModifyRole(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doCreateFlowGroupSignReview(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.CreateFlowGroupSignReviewRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.CreateFlowGroupSignReview(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeExtendedServiceAuthInfo(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DescribeExtendedServiceAuthInfoRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DescribeExtendedServiceAuthInfo(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelDescribeSignFaceVideo(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelDescribeSignFaceVideoRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelDescribeSignFaceVideo(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelCreateBoundFlows(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelCreateBoundFlowsRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
...
def doChannelCreateWebThemeConfig(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelCreateWebThemeConfigRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelCreateWebThemeConfig(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelCreateFlowReminds(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelCreateFlowRemindsRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelCreateFlowReminds(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doCreateChannelFlowEvidenceReport(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.CreateChannelFlowEvidenceReportRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.CreateChannelFlowEvidenceReport(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelCreatePreparedPersonalEsign(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelCreatePreparedPersonalEsignRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelCreatePreparedPersonalEsign(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelCreateConvertTaskApi(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelCreateConvertTaskApiRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelCreateConvertTaskApi(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelCancelFlow(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelCancelFlowRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelCancelFlow(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelCreateRole(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelCreateRoleRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelCreateRole(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeChannelSealPolicyWorkflowUrl(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DescribeChannelSealPolicyWorkflowUrlRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DescribeChannelSealPolicyWorkflowUrl(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelCreateOrganizationModifyQrCode(args, parsed_globals):
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelCreateOrganizationModifyQrCodeRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelCreateOrganizationModifyQrCode(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelCreateDynamicFlowApprover(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelCreateDynamicFlowApproverRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelCreateDynamicFlowApprover(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelVerifyPdf(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelVerifyPdfRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelVerifyPdf(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelDescribeOrganizationSeals(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelDescribeOrganizationSealsRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelDescribeOrganizationSeals(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeChannelOrganizations(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DescribeChannelOrganizationsRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
...
def doCreateRequestWithEncryption(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.CreateRequestWithEncryptionRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.CreateRequestWithEncryption(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelDescribeFlowComponents(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelDescribeFlowComponentsRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelDescribeFlowComponents(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelDeleteSealPolicies(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelDeleteSealPoliciesRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelDeleteSealPolicies(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doCreateFlowBlockchainEvidenceUrl(args, parsed_globals):
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.CreateFlowBlockchainEvidenceUrlRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.CreateFlowBlockchainEvidenceUrl(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelCreateBatchQuickSignUrl(args, parsed_globals):
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelCreateBatchQuickSignUrlRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelCreateBatchQuickSignUrl(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelDisableUserAutoSign(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelDisableUserAutoSignRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelDisableUserAutoSign(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelGetTaskResultApi(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelGetTaskResultApiRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelGetTaskResultApi(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelCreateUserAutoSignSealUrl(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelCreateUserAutoSignSealUrlRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelCreateUserAutoSignSealUrl(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelCancelUserAutoSignEnableUrl(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelCancelUserAutoSignEnableUrlRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelCancelUserAutoSignEnableUrl(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelCreateFlowSignUrl(args, parsed_globals):
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelCreateFlowSignUrlRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelCreateFlowSignUrl(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelDescribeBillUsageDetail(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelDescribeBillUsageDetailRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelDescribeBillUsageDetail(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelCreateSealPolicy(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelCreateSealPolicyRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelCreateSealPolicy(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeCancelFlowsTask(args, parsed_globals):
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DescribeCancelFlowsTaskRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
...
def doChannelCreatePrepareFlow(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelCreatePrepareFlowRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelCreatePrepareFlow(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelCreateBatchCancelFlowUrl(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelCreateBatchCancelFlowUrlRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelCreateBatchCancelFlowUrl(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelDeleteRole(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelDeleteRoleRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelDeleteRole(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelUpdateSealStatus(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelUpdateSealStatusRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelUpdateSealStatus(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelCreateBatchSignUrl(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelCreateBatchSignUrlRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelCreateBatchSignUrl(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelRenewAutoSignLicense(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelRenewAutoSignLicenseRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelRenewAutoSignLicense(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelDescribeUserAutoSignStatus(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelDescribeUserAutoSignStatusRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelDescribeUserAutoSignStatus(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelCreateReleaseFlow(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelCreateReleaseFlowRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelCreateReleaseFlow(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelDescribeEmployees(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelDescribeEmployeesRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelDescribeEmployees(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeChannelFlowEvidenceReport(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DescribeChannelFlowEvidenceReportRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DescribeChannelFlowEvidenceReport(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doChannelCreateUserAutoSignEnableUrl(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.EssbasicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ChannelCreateUserAutoSignEnableUrlRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ChannelCreateUserAutoSignEnableUrl(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
ACTION_MAP = {
    ...
    "CreateRequestWithEncryption": doCreateRequestWithEncryption,
    "SendFlow": doSendFlow,
    "DescribeFaceIdPhotos": doDescribeFaceIdPhotos,
    "ChannelDescribeFlowComponents": doChannelDescribeFlowComponents,
    "ChannelDeleteSealPolicies": doChannelDeleteSealPolicies,
    ...
    "ChannelCreatePrepareFlow": doChannelCreatePrepareFlow,
    "ChannelCreateBatchCancelFlowUrl": doChannelCreateBatchCancelFlowUrl,
    "ChannelDeleteRole": doChannelDeleteRole,
    "SyncProxyOrganization": doSyncProxyOrganization,
    "ChannelUpdateSealStatus": doChannelUpdateSealStatus,
    "CheckMobileAndName": doCheckMobileAndName,
    "ChannelCreateBatchSignUrl": doChannelCreateBatchSignUrl,
    "ChannelRenewAutoSignLicense": doChannelRenewAutoSignLicense,
    ...
    "ChannelCreateUserAutoSignEnableUrl": doChannelCreateUserAutoSignEnableUrl,
