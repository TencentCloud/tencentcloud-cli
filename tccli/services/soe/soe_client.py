...
def doInitOralProcess(args, parsed_globals):
...
def doKeywordEvaluate(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doTransmitOralProcess(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doTransmitOralProcessWithInit(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def parse_global_arg(parsed_globals):
    ...
    try:
        if g_param[OptionsDefine.ServiceVersion]:
            ...
            version = conf["soe"][OptionsDefine.Version]
            g_param[OptionsDefine.Version] = "v" + version.replace('-', '')

        if g_param[OptionsDefine.Endpoint] is None:
            g_param[OptionsDefine.Endpoint] = conf["soe"][OptionsDefine.Endpoint]
