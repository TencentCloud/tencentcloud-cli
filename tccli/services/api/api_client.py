...
from tencentcloud.api.v20201106 import api_client as api_client_v20201106
from tencentcloud.api.v20201106 import models as models_v20201106
...
def doDescribeProducts(args, parsed_globals):
    ...
    client = mod.ApiClient(cred, g_param[OptionsDefine.Region], profile)
...
CLIENT_MAP = {
    "v20201106": api_client_v20201106,

}

MODELS_MAP = {
    "v20201106": models_v20201106,
...
def parse_global_arg(parsed_globals):
    ...
    try:
        if g_param[OptionsDefine.ServiceVersion]:
            ...
            version = conf["api"][OptionsDefine.Version]
            g_param[OptionsDefine.Version] = "v" + version.replace('-', '')

        if g_param[OptionsDefine.Endpoint] is None:
            g_param[OptionsDefine.Endpoint] = conf["api"][OptionsDefine.Endpoint]
