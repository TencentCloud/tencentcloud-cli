...
from tccli.services.solar import v20181011
from tccli.services.solar.v20181011 import help as v20181011_help


def doDescribeSubProject(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("DescribeSubProject", g_param[OptionsDefine.Version])
        return
...
def doDescribeProjectStock(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("DescribeProjectStock", g_param[OptionsDefine.Version])
        return
...
def doDescribeResourceTemplateHeaders(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("DescribeResourceTemplateHeaders", g_param[OptionsDefine.Version])
        return
...
def doDescribeCustomers(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("DescribeCustomers", g_param[OptionsDefine.Version])
        return

    param = {
        "QueryType": argv.get("--QueryType"),
        "GroupId": argv.get("--GroupId"),
        "MarkFlag": Utils.try_to_json(argv, "--MarkFlag"),
        "TagIds": argv.get("--TagIds"),
        "RelChannelFlag": argv.get("--RelChannelFlag"),
        "NeedPhoneFlag": Utils.try_to_json(argv, "--NeedPhoneFlag"),
...
def doSendWxTouchTask(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("SendWxTouchTask", g_param[OptionsDefine.Version])
        return

    param = {
        "GroupId": argv.get("--GroupId"),
        "DistinctFlag": Utils.try_to_json(argv, "--DistinctFlag"),
        "IsSendNow": Utils.try_to_json(argv, "--IsSendNow"),
        "SendDate": Utils.try_to_json(argv, "--SendDate"),
        "TaskName": argv.get("--TaskName"),
        "WxTouchType": argv.get("--WxTouchType"),
        "Title": argv.get("--Title"),
        "Content": argv.get("--Content"),
        "NewsId": argv.get("--NewsId"),
        "SmallProgramId": argv.get("--SmallProgramId"),
...
def doDescribeProjects(argv, arglist):
    ...
    param = {
        "PageNo": Utils.try_to_json(argv, "--PageNo"),
        "PageSize": Utils.try_to_json(argv, "--PageSize"),
        "SearchWord": argv.get("--SearchWord"),
        "Filters": Utils.try_to_json(argv, "--Filters"),
        "ProjectStatus": Utils.try_to_json(argv, "--ProjectStatus"),
...
def doOffLineProject(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("OffLineProject", g_param[OptionsDefine.Version])
        return
...
def doExpireFlow(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("ExpireFlow", g_param[OptionsDefine.Version])
        return
...
def doCheckStaffChUser(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("CheckStaffChUser", g_param[OptionsDefine.Version])
        return

    param = {
        "UserId": Utils.try_to_json(argv, "--UserId"),
        "OperateType": argv.get("--OperateType"),
...
def doDescribeCustomer(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("DescribeCustomer", g_param[OptionsDefine.Version])
        return
...
def doCreateSubProject(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("CreateSubProject", g_param[OptionsDefine.Version])
        return

    param = {
        "ProjectId": argv.get("--ProjectId"),
        "SubProjectName": argv.get("--SubProjectName"),
...
def doCopyActivityChannel(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("CopyActivityChannel", g_param[OptionsDefine.Version])
        return

    param = {
        "ActivityId": argv.get("--ActivityId"),
        "ChannelFrom": argv.get("--ChannelFrom"),
        "ChannelTo": Utils.try_to_json(argv, "--ChannelTo"),
...
AVAILABLE_VERSIONS = {
     'v' + v20181011.version.replace('-', ''): {"help": v20181011_help.INFO,"desc": v20181011_help.DESC},

}


def solar_action(argv, arglist):
    if "help" in argv:
        ...
        helpstr = HelpTemplate.SERVICE % {"name": "solar", "desc": desc, "actions": action_str}
        print(helpstr)
    else:
...
def register_arg(command):
    cmd = NiceCommand("solar", solar_action)
    command.reg_cmd(cmd)
...
def parse_global_arg(argv):
    ...
    try:
        if params[OptionsDefine.Version] is None:
            version = config["solar"][OptionsDefine.Version]
            params[OptionsDefine.Version] = "v" + version.replace('-', '')

        if params[OptionsDefine.Endpoint] is None:
            params[OptionsDefine.Endpoint] = config["solar"][OptionsDefine.Endpoint]
...
def show_help(action, version):
    ...
    helpmsg = HelpTemplate.ACTION % {"name": action, "service": "solar", "desc": desc, "params": docstr}
    print(helpmsg)
