...
def doDescribeBizConfig(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("DescribeBizConfig", g_param[OptionsDefine.Version])
        return
...
def doCreateBizConfig(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("CreateBizConfig", g_param[OptionsDefine.Version])
        return

    param = {
        "BizType": argv.get("--BizType"),
        "MediaModeration": Utils.try_to_json(argv, "--MediaModeration"),
        "BizName": argv.get("--BizName"),
        "ModerationCategories": Utils.try_to_json(argv, "--ModerationCategories"),
