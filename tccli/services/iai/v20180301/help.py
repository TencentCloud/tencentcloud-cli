...
INFO = {
  ...
  "SearchFaces": {
    "params": [
      ...
      {
        "name": "QualityControl",
        "desc": "图片质量控制，若图片中包含多张人脸，会对要求处理的人脸进行质量控制判断。  \n0: 不进行控制， \n1:较低的质量要求， \n2: 一般的质量要求， \n3: 较高的质量要求。 \n4: 很高的质量要求。 \n默认 0。 \n若图片质量不满足要求，则返回结果中会提示图片质量检测不符要求。"
      },
      {
        "name": "FaceMatchThreshold",
