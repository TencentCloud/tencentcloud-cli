...
def doDescribeRiskModel(args, parsed_globals):
    ...
    model = models.DescribeRiskModelRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DescribeRiskModel(model)
...
ACTION_MAP = {
    "DescribeRiskModel": doDescribeRiskModel,
