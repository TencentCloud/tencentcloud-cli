...
from tencentcloud.bsca.v20210811 import bsca_client as bsca_client_v20210811
from tencentcloud.bsca.v20210811 import models as models_v20210811

from jmespath import search
import time

def doSearchKBComponent(args, parsed_globals):
    ...
    while True:
        rsp = client.SearchKBComponent(model)
...
def doDescribeKBComponentVersionList(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    start_time = time.time()
    while True:
        rsp = client.DescribeKBComponentVersionList(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
MODELS_MAP = {
    "v20210811": models_v20210811,

}

ACTION_MAP = {
    "SearchKBComponent": doSearchKBComponent,
    "DescribeKBComponentVersionList": doDescribeKBComponentVersionList,
...
def parse_global_arg(parsed_globals):
    ...
    try:
        if g_param[OptionsDefine.ServiceVersion]:
            ...
            version = conf["bsca"][OptionsDefine.Version]
