...
def doDescribeConcurrentRecordStreamNum(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doCreateLiveRecord(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doUpdateLiveWatermark(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doDescribeLiveStreamEventList(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doDescribeHttpStatusInfoList(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doDescribeProvinceIspPlayInfoList(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doDeleteLiveAvatarCloneFigure(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LiveClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DeleteLiveAvatarCloneFigureRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DeleteLiveAvatarCloneFigure(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doCreateLiveAvatarCloneFigure(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LiveClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.CreateLiveAvatarCloneFigureRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.CreateLiveAvatarCloneFigure(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doCreateLiveTimeShiftRule(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LiveClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.CreateLiveTimeShiftRuleRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.CreateLiveTimeShiftRule(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doRestartLivePullStreamTask(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LiveClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.RestartLivePullStreamTaskRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
...
def doCreateLiveTimeShiftTemplate(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LiveClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.CreateLiveTimeShiftTemplateRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
...
def doModifyLiveDomainReferer(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LiveClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ModifyLiveDomainRefererRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ModifyLiveDomainReferer(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeBackupStreamList(args, parsed_globals):
    ...
    client = mod.LiveClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DescribeBackupStreamListRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DescribeBackupStreamList(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doCreateLiveTranscodeTemplate(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doDescribeLiveAvatarCloneFigureList(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LiveClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DescribeLiveAvatarCloneFigureListRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DescribeLiveAvatarCloneFigureList(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doEnableLiveDomain(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
ACTION_MAP = {
    ...
    "DeleteLiveAvatarCloneFigure": doDeleteLiveAvatarCloneFigure,
...
def parse_global_arg(parsed_globals):
    ...
    try:
        if g_param[OptionsDefine.ServiceVersion]:
            ...
            version = conf["live"][OptionsDefine.Version]
            g_param[OptionsDefine.Version] = "v" + version.replace('-', '')

        if g_param[OptionsDefine.Endpoint] is None:
            g_param[OptionsDefine.Endpoint] = conf["live"][OptionsDefine.Endpoint]
