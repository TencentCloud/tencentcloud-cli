...
def doCreateStorage(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("CreateStorage", g_param[OptionsDefine.Version])
        return

    param = {
        "PkgId": argv.get("--PkgId"),
        "Tid": argv.get("--Tid"),
        "UserTag": argv.get("--UserTag"),
...
def doModifyDeviceProperty(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("ModifyDeviceProperty", g_param[OptionsDefine.Version])
        return
