...
def doCancelFaceMorphJob(args, parsed_globals):
...
def doSwapGenderPic(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doMorphFace(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doChangeAgePic(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doQueryFaceMorphJob(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doFaceCartoonPic(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def parse_global_arg(parsed_globals):
    ...
    try:
        if g_param[OptionsDefine.ServiceVersion]:
            ...
            version = conf["ft"][OptionsDefine.Version]
            g_param[OptionsDefine.Version] = "v" + version.replace('-', '')

        if g_param[OptionsDefine.Endpoint] is None:
            g_param[OptionsDefine.Endpoint] = conf["ft"][OptionsDefine.Endpoint]
