...
def doBatchGetPlaybackToken(args, parsed_globals):
    ...
    model = models.BatchGetPlaybackTokenRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.BatchGetPlaybackToken(model)
...
def doDescribeRoomForbiddenUser(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DescribeRoomForbiddenUserRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DescribeRoomForbiddenUser(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribePlayRecords(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DescribePlayRecordsRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DescribePlayRecords(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDeleteAppCustomContent(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DeleteAppCustomContentRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DeleteAppCustomContent(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doKickUserFromRoom(args, parsed_globals):
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.KickUserFromRoomRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.KickUserFromRoom(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doLoginUserWithRoom(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.LoginUserWithRoomRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.LoginUserWithRoom(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeGroupLiveCodes(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DescribeGroupLiveCodesRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DescribeGroupLiveCodes(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeEditVersions(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DescribeEditVersionsRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DescribeEditVersions(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doStartRoom(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.StartRoomRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.StartRoom(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doGetPlaybackToken(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.GetPlaybackTokenRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.GetPlaybackToken(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doLoginOriginIdWithRoom(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.LoginOriginIdWithRoomRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.LoginOriginIdWithRoom(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeSupervisors(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DescribeSupervisorsRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DescribeSupervisors(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doBatchDescribeDocument(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.BatchDescribeDocumentRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.BatchDescribeDocument(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doCreateGroupLiveCodes(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.CreateGroupLiveCodesRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.CreateGroupLiveCodes(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeLiveRelayConfig(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DescribeLiveRelayConfigRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DescribeLiveRelayConfig(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeDocuments(args, parsed_globals):
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DescribeDocumentsRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DescribeDocuments(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doSendRoomNormalMessage(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.SendRoomNormalMessageRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.SendRoomNormalMessage(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDeleteSupervisor(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DeleteSupervisorRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DeleteSupervisor(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doGetEditVersionToken(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.GetEditVersionTokenRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.GetEditVersionToken(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doSetMainEditVersion(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.SetMainEditVersionRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.SetMainEditVersion(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribePlaybackList(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DescribePlaybackListRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DescribePlaybackList(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doForbidSendMsg(args, parsed_globals):
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ForbidSendMsgRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ForbidSendMsg(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeQuestionList(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DescribeQuestionListRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DescribeQuestionList(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doModifyLiveRelayConfig(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ModifyLiveRelayConfigRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ModifyLiveRelayConfig(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeAppDetail(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DescribeAppDetailRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DescribeAppDetail(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doGetRoomEvent(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.GetRoomEventRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.GetRoomEvent(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doEndRoom(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.EndRoomRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.EndRoom(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeAnswerList(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DescribeAnswerListRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DescribeAnswerList(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doSendRoomNotificationMessage(args, parsed_globals):
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.SendRoomNotificationMessageRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.SendRoomNotificationMessage(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDeletePlaybackItem(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DeletePlaybackItemRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DeletePlaybackItem(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doGetRooms(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.GetRoomsRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.GetRooms(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeScoreList(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DescribeScoreListRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DescribeScoreList(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeDeveloper(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client = mod.LcicClient(cred, g_param[OptionsDefine.Region], profile)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DescribeDeveloperRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DescribeDeveloper(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
ACTION_MAP = {
    ...
    "LoginUserWithRoom": doLoginUserWithRoom,
    "GetWatermark": doGetWatermark,
    "DescribeGroupLiveCodes": doDescribeGroupLiveCodes,
    "DescribeEditVersions": doDescribeEditVersions,
    ...
    "GetPlaybackToken": doGetPlaybackToken,
    "CreateDocument": doCreateDocument,
    "LoginOriginIdWithRoom": doLoginOriginIdWithRoom,
    "DescribeSupervisors": doDescribeSupervisors,
    "ModifyRoom": doModifyRoom,
    "DescribeUser": doDescribeUser,
    "BatchDescribeDocument": doBatchDescribeDocument,
    ...
    "CreateGroupLiveCodes": doCreateGroupLiveCodes,
    "DescribeLiveRelayConfig": doDescribeLiveRelayConfig,
    ...
    "GetEditVersionToken": doGetEditVersionToken,
    "BindDocumentToRoom": doBindDocumentToRoom,
    "SetMainEditVersion": doSetMainEditVersion,
    "DescribePlaybackList": doDescribePlaybackList,
