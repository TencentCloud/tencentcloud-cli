...
def doDescribeTeams(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doExportVideoEditProject(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doDescribeSharedSpace(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doGenerateVideoSegmentationSchemeByAi(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client._sdkVersion += ("_CLI_" + __version__)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.GenerateVideoSegmentationSchemeByAiRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.GenerateVideoSegmentationSchemeByAi(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doExportVideoByVideoSegmentationData(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client._sdkVersion += ("_CLI_" + __version__)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ExportVideoByVideoSegmentationDataRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ExportVideoByVideoSegmentationData(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doGrantResourceAuthorization(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doSearchMaterial(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doDescribeJoinTeams(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doDescribeResourceAuthorization(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doExportVideoByEditorTrackData(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doCreateVideoEncodingPreset(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client._sdkVersion += ("_CLI_" + __version__)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.CreateVideoEncodingPresetRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.CreateVideoEncodingPreset(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDeleteMaterial(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doDescribeVideoEncodingPresets(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client._sdkVersion += ("_CLI_" + __version__)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DescribeVideoEncodingPresetsRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DescribeVideoEncodingPresets(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doMoveClass(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doDeleteVideoEncodingPreset(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client._sdkVersion += ("_CLI_" + __version__)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DeleteVideoEncodingPresetRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DeleteVideoEncodingPreset(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDeleteTeamMembers(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doDeleteLoginStatus(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doDescribeLoginStatus(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doModifyVideoEncodingPreset(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client._sdkVersion += ("_CLI_" + __version__)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ModifyVideoEncodingPresetRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ModifyVideoEncodingPreset(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doHandleStreamConnectProject(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client._sdkVersion += ("_CLI_" + __version__)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.HandleStreamConnectProjectRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.HandleStreamConnectProject(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doModifyMaterial(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doImportMediaToProject(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doForbidAccount(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client._sdkVersion += ("_CLI_" + __version__)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ForbidAccountRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ForbidAccount(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doListMedia(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doRevokeResourceAuthorization(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doExportVideoByTemplate(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client._sdkVersion += ("_CLI_" + __version__)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ExportVideoByTemplateRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ExportVideoByTemplate(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doMoveResource(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client._sdkVersion += ("_CLI_" + __version__)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.MoveResourceRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.MoveResource(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doFlattenListMedia(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doHandleMediaCastProject(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client._sdkVersion += ("_CLI_" + __version__)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.HandleMediaCastProjectRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.HandleMediaCastProject(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
ACTION_MAP = {
    ...
    "GenerateVideoSegmentationSchemeByAi": doGenerateVideoSegmentationSchemeByAi,
    "ExportVideoByVideoSegmentationData": doExportVideoByVideoSegmentationData,
    ...
    "ModifyVideoEncodingPreset": doModifyVideoEncodingPreset,
    "DescribeTasks": doDescribeTasks,
    "HandleStreamConnectProject": doHandleStreamConnectProject,
...
def parse_global_arg(parsed_globals):
    ...
    try:
        if g_param[OptionsDefine.ServiceVersion]:
            ...
            version = conf["cme"][OptionsDefine.Version]
            g_param[OptionsDefine.Version] = "v" + version.replace('-', '')

        if g_param[OptionsDefine.Endpoint] is None:
            g_param[OptionsDefine.Endpoint] = conf["cme"][OptionsDefine.Endpoint]
