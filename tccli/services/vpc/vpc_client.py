...
def doDescribeNatsEipsInternal(args, parsed_globals):
    ...
    model = models.DescribeNatsEipsInternalRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DescribeNatsEipsInternal(model)
...
ACTION_MAP = {
    "DescribeNatsEipsInternal": doDescribeNatsEipsInternal,
