...
from tencentcloud.cdwch.v20200915 import cdwch_client as cdwch_client_v20200915
from tencentcloud.cdwch.v20200915 import models as models_v20200915
...
def doDescribeEventTasks(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client._sdkVersion += ("_CLI_" + __version__)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DescribeEventTasksRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.DescribeEventTasks(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
CLIENT_MAP = {
    "v20200915": cdwch_client_v20200915,

}

MODELS_MAP = {
    "v20200915": models_v20200915,
...
ACTION_MAP = {
    ...
    "DescribeEventTasks": doDescribeEventTasks,
...
def parse_global_arg(parsed_globals):
    ...
    try:
        if g_param[OptionsDefine.ServiceVersion]:
            ...
            version = conf["cdwch"][OptionsDefine.Version]
            g_param[OptionsDefine.Version] = "v" + version.replace('-', '')

        if g_param[OptionsDefine.Endpoint] is None:
            g_param[OptionsDefine.Endpoint] = conf["cdwch"][OptionsDefine.Endpoint]
