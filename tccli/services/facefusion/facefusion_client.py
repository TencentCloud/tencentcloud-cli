...
def doDescribeMaterialList(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("DescribeMaterialList", g_param[OptionsDefine.Version])
        return
...
def doFuseFace(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("FuseFace", g_param[OptionsDefine.Version])
        return
