...
def doAuthTestTid(args, parsed_globals):
...
def doUploadDeviceUniqueCode(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client._sdkVersion += ("_CLI_" + __version__)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.UploadDeviceUniqueCodeRequest()
    model.from_json_string(json.dumps(args))
    rsp = client.UploadDeviceUniqueCode(model)
    result = rsp.to_json_string()
    try:
        json_obj = json.loads(result)
    except TypeError as e:
...
def doVerifyChipBurnInfo(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doDeliverTids(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doBurnTidNotify(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doDescribePermission(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doDeliverTidNotify(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doDownloadTids(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doDescribeAvailableLibCount(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client._sdkVersion += ("_CLI_" + __version__)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.DescribeAvailableLibCountRequest()
    model.from_json_string(json.dumps(args))
    rsp = client.DescribeAvailableLibCount(model)
    result = rsp.to_json_string()
    try:
        json_obj = json.loads(result)
    except TypeError as e:
...
ACTION_MAP = {
    ...
    "UploadDeviceUniqueCode": doUploadDeviceUniqueCode,
    ...
    "DescribeAvailableLibCount": doDescribeAvailableLibCount,
...
def parse_global_arg(parsed_globals):
    ...
    try:
        if g_param[OptionsDefine.ServiceVersion]:
            ...
            version = conf["iottid"][OptionsDefine.Version]
            g_param[OptionsDefine.Version] = "v" + version.replace('-', '')

        if g_param[OptionsDefine.Endpoint] is None:
            g_param[OptionsDefine.Endpoint] = conf["iottid"][OptionsDefine.Endpoint]
