...
def doDescribeDict(args, parsed_globals):
...
def doSearchWordItems(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doDeleteWordItems(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doUpdateDict(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doDependencyParsing(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doEvaluateSentenceSimilarity(args, parsed_globals):
    ...
    client._sdkVersion += ("_CLI_" + __version__)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.EvaluateSentenceSimilarityRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.EvaluateSentenceSimilarity(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeDicts(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doCreateDict(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doGeneratePoetry(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client._sdkVersion += ("_CLI_" + __version__)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.GeneratePoetryRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.GeneratePoetry(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doParseWords(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client._sdkVersion += ("_CLI_" + __version__)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.ParseWordsRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.ParseWords(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doWordSimilarity(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doSentenceEmbedding(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doDescribeWordItems(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doTextCorrection(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doEvaluateWordSimilarity(args, parsed_globals):
    ...
    client._sdkVersion += ("_CLI_" + __version__)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.EvaluateWordSimilarityRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.EvaluateWordSimilarity(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doGenerateCouplet(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client._sdkVersion += ("_CLI_" + __version__)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.GenerateCoupletRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.GenerateCouplet(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doTextSimilarityPro(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    client._sdkVersion += ("_CLI_" + __version__)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.TextSimilarityProRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.TextSimilarityPro(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doTextSimilarity(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doSentimentAnalysis(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doLexicalAnalysis(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doRetrieveSimilarWords(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doKeywordsExtraction(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doTextCorrectionPro(args, parsed_globals):
    ...
    client._sdkVersion += ("_CLI_" + __version__)
    models = MODELS_MAP[g_param[OptionsDefine.Version]]
    model = models.TextCorrectionProRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.TextCorrectionPro(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doWordEmbedding(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doDeleteDict(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doAutoSummarization(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def parse_global_arg(parsed_globals):
    ...
    try:
        if g_param[OptionsDefine.ServiceVersion]:
            ...
            version = conf["nlp"][OptionsDefine.Version]
            g_param[OptionsDefine.Version] = "v" + version.replace('-', '')

        if g_param[OptionsDefine.Endpoint] is None:
            g_param[OptionsDefine.Endpoint] = conf["nlp"][OptionsDefine.Endpoint]
