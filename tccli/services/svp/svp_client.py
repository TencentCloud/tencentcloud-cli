...
from tencentcloud.svp.v20240125 import svp_client as svp_client_v20240125
from tencentcloud.svp.v20240125 import models as models_v20240125
...
def parse_global_arg(parsed_globals):
    ...
    try:
        if g_param[OptionsDefine.ServiceVersion]:
            ...
            version = conf["svp"][OptionsDefine.Version]
            g_param[OptionsDefine.Version] = "v" + version.replace('-', '')

        if g_param[OptionsDefine.Endpoint] is None:
            g_param[OptionsDefine.Endpoint] = conf["svp"][OptionsDefine.Endpoint]
