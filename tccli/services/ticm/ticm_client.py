...
def doVideoModeration(argv, arglist):
    ...
    param = {
        "VideoUrl": argv.get("--VideoUrl"),
        "DeveloperId": argv.get("--DeveloperId"),
        "CBUrl": argv.get("--CBUrl"),
        "Extra": argv.get("--Extra"),
...
def doDescribeVideoTask(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("DescribeVideoTask", g_param[OptionsDefine.Version])
        return

    param = {
        "VodTaskId": argv.get("--VodTaskId"),
