...
from tccli.services.tbm import v20180129
from tccli.services.tbm.v20180129 import help as v20180129_help


def doDescribeUserPortrait(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("DescribeUserPortrait", g_param[OptionsDefine.Version])
        return
...
def doDescribeBrandPosComments(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("DescribeBrandPosComments", g_param[OptionsDefine.Version])
        return
...
def doDescribeIndustryNews(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("DescribeIndustryNews", g_param[OptionsDefine.Version])
        return
...
def doDescribeBrandMediaReport(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("DescribeBrandMediaReport", g_param[OptionsDefine.Version])
        return
...
def doDescribeBrandNegComments(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("DescribeBrandNegComments", g_param[OptionsDefine.Version])
        return
...
def doDescribeBrandSocialReport(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("DescribeBrandSocialReport", g_param[OptionsDefine.Version])
        return
...
def doDescribeBrandSocialOpinion(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("DescribeBrandSocialOpinion", g_param[OptionsDefine.Version])
        return
...
def doDescribeBrandCommentCount(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("DescribeBrandCommentCount", g_param[OptionsDefine.Version])
        return
...
def doDescribeBrandExposure(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("DescribeBrandExposure", g_param[OptionsDefine.Version])
        return
...
AVAILABLE_VERSIONS = {
     'v' + v20180129.version.replace('-', ''): {"help": v20180129_help.INFO,"desc": v20180129_help.DESC},

}


def tbm_action(argv, arglist):
    if "help" in argv:
        ...
        helpstr = HelpTemplate.SERVICE % {"name": "tbm", "desc": desc, "actions": action_str}
        print(helpstr)
    else:
...
def register_arg(command):
    cmd = NiceCommand("tbm", tbm_action)
    command.reg_cmd(cmd)
...
def parse_global_arg(argv):
    ...
    try:
        if params[OptionsDefine.Version] is None:
            version = config["tbm"][OptionsDefine.Version]
            params[OptionsDefine.Version] = "v" + version.replace('-', '')

        if params[OptionsDefine.Endpoint] is None:
            params[OptionsDefine.Endpoint] = config["tbm"][OptionsDefine.Endpoint]
...
def show_help(action, version):
    ...
    helpmsg = HelpTemplate.ACTION % {"name": action, "service": "tbm", "desc": desc, "params": docstr}
    print(helpmsg)
