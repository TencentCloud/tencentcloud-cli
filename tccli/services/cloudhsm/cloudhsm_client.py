...
def doDescribeHSMByVpcId(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("DescribeHSMByVpcId", g_param[OptionsDefine.Version])
        return
...
def doDescribeHSMBySubnetId(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("DescribeHSMBySubnetId", g_param[OptionsDefine.Version])
        return
