...
def doDeleteTextSample(argv, arglist):
    ...
    if "help" in argv:
        show_help("DeleteTextSample", g_param[OptionsDefine.Version])
        return
...
def doCreateTextSample(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("CreateTextSample", g_param[OptionsDefine.Version])
        return
...
def doCreateFileSample(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("CreateFileSample", g_param[OptionsDefine.Version])
        return
...
def doManualReview(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("ManualReview", g_param[OptionsDefine.Version])
        return

    param = {
        "ReviewContent": Utils.try_to_json(argv, "--ReviewContent"),
...
def doDescribeFileSample(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("DescribeFileSample", g_param[OptionsDefine.Version])
        return
...
def doDeleteFileSample(argv, arglist):
    g_param = parse_global_arg(argv)
    if "help" in argv:
        show_help("DeleteFileSample", g_param[OptionsDefine.Version])
        return
