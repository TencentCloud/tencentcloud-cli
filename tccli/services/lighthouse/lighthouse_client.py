...
def doModifyFirewallTemplate(args, parsed_globals):
    ...
    while True:
        rsp = client.ModifyFirewallTemplate(model)
...
def doDeleteBlueprints(args, parsed_globals):
    ...
    start_time = time.time()
    while True:
        rsp = client.DeleteBlueprints(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doRenameDockerContainer(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    start_time = time.time()
    while True:
        rsp = client.RenameDockerContainer(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeBundleDiscount(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doModifyBlueprintAttribute(args, parsed_globals):
    ...
    start_time = time.time()
    while True:
        rsp = client.ModifyBlueprintAttribute(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doRestartDockerContainers(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    start_time = time.time()
    while True:
        rsp = client.RestartDockerContainers(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeFirewallTemplateRules(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    start_time = time.time()
    while True:
        rsp = client.DescribeFirewallTemplateRules(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doModifyDiskBackupsAttribute(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    start_time = time.time()
    while True:
        rsp = client.ModifyDiskBackupsAttribute(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeDockerContainerConfiguration(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    start_time = time.time()
    while True:
        rsp = client.DescribeDockerContainerConfiguration(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doModifyFirewallRules(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    start_time = time.time()
    while True:
        rsp = client.ModifyFirewallRules(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeFirewallTemplateQuota(args, parsed_globals):
    ...
    start_time = time.time()
    while True:
        rsp = client.DescribeFirewallTemplateQuota(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doCreateFirewallTemplate(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    start_time = time.time()
    while True:
        rsp = client.CreateFirewallTemplate(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeBlueprints(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    start_time = time.time()
    while True:
        rsp = client.DescribeBlueprints(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doModifyDockerContainer(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    start_time = time.time()
    while True:
        rsp = client.ModifyDockerContainer(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doInquirePriceCreateInstances(args, parsed_globals):
    ...
    start_time = time.time()
    while True:
        rsp = client.InquirePriceCreateInstances(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doModifyDisksBackupQuota(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    start_time = time.time()
    while True:
        rsp = client.ModifyDisksBackupQuota(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeDockerContainers(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    start_time = time.time()
    while True:
        rsp = client.DescribeDockerContainers(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doCreateFirewallTemplateRules(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    start_time = time.time()
    while True:
        rsp = client.CreateFirewallTemplateRules(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doIsolateInstances(args, parsed_globals):
    ...
    start_time = time.time()
    while True:
        rsp = client.IsolateInstances(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeDockerActivities(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    start_time = time.time()
    while True:
        rsp = client.DescribeDockerActivities(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doStartDockerContainers(args, parsed_globals):
    ...
    start_time = time.time()
    while True:
        rsp = client.StartDockerContainers(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeInstancesTrafficPackages(args, parsed_globals):
    ...
    start_time = time.time()
    while True:
        rsp = client.DescribeInstancesTrafficPackages(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeFirewallTemplateRuleQuota(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    start_time = time.time()
    while True:
        rsp = client.DescribeFirewallTemplateRuleQuota(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doModifyFirewallRuleDescription(args, parsed_globals):
    ...
    start_time = time.time()
    while True:
        rsp = client.ModifyFirewallRuleDescription(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doModifyInstancesBundle(args, parsed_globals):
    ...
    start_time = time.time()
    while True:
        rsp = client.ModifyInstancesBundle(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDeleteFirewallTemplateRules(args, parsed_globals):
    ...
    start_time = time.time()
    while True:
        rsp = client.DeleteFirewallTemplateRules(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doRunDockerContainers(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    start_time = time.time()
    while True:
        rsp = client.RunDockerContainers(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeInstancesReturnable(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    start_time = time.time()
    while True:
        rsp = client.DescribeInstancesReturnable(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doInquirePriceCreateBlueprint(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    start_time = time.time()
    while True:
        rsp = client.InquirePriceCreateBlueprint(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeFirewallTemplateApplyRecords(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    start_time = time.time()
    while True:
        rsp = client.DescribeFirewallTemplateApplyRecords(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doResetFirewallTemplateRules(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
...
def doDescribeResetInstanceBlueprints(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    start_time = time.time()
    while True:
        rsp = client.DescribeResetInstanceBlueprints(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doApplyInstanceSnapshot(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    start_time = time.time()
    while True:
        rsp = client.ApplyInstanceSnapshot(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doReplaceFirewallTemplateRule(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    start_time = time.time()
    while True:
        rsp = client.ReplaceFirewallTemplateRule(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
def doDescribeFirewallTemplates(args, parsed_globals):
    g_param = parse_global_arg(parsed_globals)
    ...
    start_time = time.time()
    while True:
        rsp = client.DescribeFirewallTemplates(model)
        result = rsp.to_json_string()
        try:
            json_obj = json.loads(result)
        except TypeError as e:
...
ACTION_MAP = {
    ...
    "ModifyDiskBackupsAttribute": doModifyDiskBackupsAttribute,
...
def parse_global_arg(parsed_globals):
    ...
    try:
        if g_param[OptionsDefine.ServiceVersion]:
            ...
            version = conf["lighthouse"][OptionsDefine.Version]
            g_param[OptionsDefine.Version] = "v" + version.replace('-', '')

        if g_param[OptionsDefine.Endpoint] is None:
            g_param[OptionsDefine.Endpoint] = conf["lighthouse"][OptionsDefine.Endpoint]
