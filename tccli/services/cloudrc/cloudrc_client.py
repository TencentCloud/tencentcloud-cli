...
from tencentcloud.cloudrc.v20240606 import cloudrc_client as cloudrc_client_v20240606
from tencentcloud.cloudrc.v20240606 import models as models_v20240606
...
def parse_global_arg(parsed_globals):
    ...
    try:
        if g_param[OptionsDefine.ServiceVersion]:
            ...
            version = conf["cloudrc"][OptionsDefine.Version]
            g_param[OptionsDefine.Version] = "v" + version.replace('-', '')

        if g_param[OptionsDefine.Endpoint] is None:
            g_param[OptionsDefine.Endpoint] = conf["cloudrc"][OptionsDefine.Endpoint]
