...
```
tccli fwm CreateSecurityGroupRule --cli-unfold-argument  \
    --GroupId fwmrg-jvw5ulal \
    --Rules.0.IpVersion ipv4 \
    --Rules.0.SourceContent lhins-qwgbsmg1 \
...
{
    "Response": {
        "RequestId": "9a66b372-86ef-488c-b53b-f93951c880a3"
    }
}
```
