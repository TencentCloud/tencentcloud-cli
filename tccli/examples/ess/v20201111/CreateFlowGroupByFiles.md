...
**Example 2: 创建一个有3份子合同的合同组签署流程（B2B、B2B、B2C），指定每个子合同第一方为动态签署方**
...
**Example 3: 创建一个有3份子合同的合同组签署流程（B2B（含自动签署）、B2B、B2C）**
...
**Example 4: 通过主代子方式创建一个有3份子合同的合同组签署流程（B2B（含自动签署）、B2B、B2C）**
