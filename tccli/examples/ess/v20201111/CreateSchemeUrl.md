**Example 1: 指定证件信息，给企业员工生成跳转到电子签小程序的签署链接**
...
**Example 3: 获取动态签署人补充链接（短链）并预设企业名**
...
**Example 6: 获取合同组动态签署人补充链接（短链）并预设企业名**
...
**Example 9: 获取某个流程合同的小程序跳转签署链接(隐藏某些按钮)**
...
**Example 11: 错误的示例- 获取某个流程合同的小程序跳转签署链接，PathType值没有传对（应该传1- 小程序合同详情）**
