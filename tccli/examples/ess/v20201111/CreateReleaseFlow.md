...
**Example 3: 发起解除协议（替换原流程中本企业的参与人并指定其为“授权签”）**

1. 更换原合同中本方企业的参与人
2. 给该企业参与人指定“授权签”(ApproverType 设置为 ENTERPRISESERVER)
...
**Example 6: 发起解除协议（默认情况，使用原流程的签署人）**
...
**Example 7: 错误示例-解除协议中更换原合同个人类型的参与人**
