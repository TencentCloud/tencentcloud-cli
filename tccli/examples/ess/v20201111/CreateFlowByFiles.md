...
**Example 7: 创建只有个人C端签署, 签署人需要人脸校验认证的合同流程 **
...
**Example 9: 发起合同后添加签署区-指定签署控件和印章的无序签署示例合同**
...
**Example 11: 文件发起B2C合同，使用关键字方式，签署方设置签批控件**
...
**Example 12: 文件发起B2C合同，发起方设置合同水印（自定义水印内容）**
...
**Example 13: 文件发起B2C合同，签署双方和发起方都有填写控件**
...
**Example 14: 文件发起B2C合同，签署方设置签批控件**
...
**Example 15: 标书场景下，需要创建一份本方企业和个人签署的标书文件，要求本方企业的印章控件需要在每一页都进行盖章。**
...
**Example 16: 通过文件发起B2C合同-控件使用关键字定位方式**
...
**Example 17: 通过文件发起B2C合同-控件使用绝对定位方式**
