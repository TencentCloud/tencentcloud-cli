**Example 1: 根据分类搜索一定时间范围内的图片文件，并只返回文件基础信息，并且按创建时间降序排序**
...
**Example 2: 根据推流直播码搜索一定时间范围内的录制文件，并且按创建时间降序排序**
...
**Example 3: 根据文件名字前缀搜索一定时间范围内的文件，并且按创建时间降序排序**
...
**Example 4: 根据文件名字模糊搜索一定时间范围内的文件，并且按创建时间降序排序**
...
**Example 5: 根据标签搜索一定时间范围内的上传文件，并且按创建时间降序排序**
