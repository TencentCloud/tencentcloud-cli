...
tccli vod ModifyMediaInfo --cli-unfold-argument  \
    --FileId 123 \
    --AddKeyFrameDescs.0.TimeOffset 1.0 \
    --AddKeyFrameDescs.0.Content 测试内容1 \
    --AddKeyFrameDescs.1.TimeOffset 2.0 \
    --AddKeyFrameDescs.1.Content 测试内容2 \
