...
tccli vod CreateProcedureTemplate --cli-unfold-argument  \
    ...
    --MediaProcessTask.TranscodeTaskSet.0.WatermarkSet.0.EndTimeOffset 0 \
    ...
    --MediaProcessTask.TranscodeTaskSet.0.WatermarkSet.0.StartTimeOffset 0 \
    --MediaProcessTask.TranscodeTaskSet.1.Definition 20 \
    --MediaProcessTask.TranscodeTaskSet.1.WatermarkSet.0.EndTimeOffset 0 \
    ...
    --MediaProcessTask.TranscodeTaskSet.1.WatermarkSet.0.StartTimeOffset 0 \
    --MediaProcessTask.TranscodeTaskSet.2.Definition 40 \
    --MediaProcessTask.TranscodeTaskSet.2.WatermarkSet.0.EndTimeOffset 0 \
    ...
    --MediaProcessTask.TranscodeTaskSet.2.WatermarkSet.0.StartTimeOffset 0 \
    --Name 我的一个任务流
```
