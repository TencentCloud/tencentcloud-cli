**Example 1: hunyuan-functioncall模型多轮对话示例**
...
**Example 2: hunyuan-functioncall模型流式请求成功示例**
...
**Example 3: hunyuan-functioncall模型非流式请求成功示例**
...
tccli hunyuan ChatCompletions --cli-unfold-argument  \
    ...
    --Messages.0.Contents.0.Text 图片上有什么内容？ \
    ...
    --Messages.0.Contents.2.ImageUrl.Url https://qcloudimg.tencent-cloud.cn/raw/42c198dbc0b57ae490e57f89aa01ec23.png \
    --Stream False
```
