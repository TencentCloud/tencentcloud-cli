...
**Example 2: 【合成任务】剪辑&片头&片尾&水印图片&文字&音频替换**
...
tccli mps EditMedia --cli-unfold-argument  \
    ...
    --ComposeConfig.Tracks.2.Items.0.Video.AudioOperations.0.Volume 0 \
    ...
    --ComposeConfig.Tracks.2.Items.1.Video.AudioOperations.0.Volume 0 \
...
tccli mps EditMedia --cli-unfold-argument  \
    ...
    --ComposeConfig.Tracks.0.Items.0.Video.AudioOperations.0.Volume 0 \
