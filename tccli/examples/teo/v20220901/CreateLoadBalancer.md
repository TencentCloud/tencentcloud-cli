...
**Example 2: 创建健康检查策略为 HTTP 的负载均衡实例**
...
**Example 3: 创建健康检查策略为 HTTPS 的负载均衡实例**
...
**Example 4: 创建健康检查策略为 ICMP Ping 的负载均衡实例**
...
**Example 5: 创建健康检查策略为 TCP 的负载均衡实例**
...
**Example 6: 创建健康检查策略为 UDP 的负载均衡实例**
