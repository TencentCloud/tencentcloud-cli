...
tccli tke CreatePrometheusTemp --cli-unfold-argument  \
    ...
    --Template.AlertDetailRules.0.Notification.AlertManager.ClusterType abc \
    --Template.AlertDetailRules.0.Notification.AlertManager.ClusterId abc \
    --Template.AlertDetailRules.0.Notification.AlertManager.Url abc \
    ...
    --Template.AlertDetailRules.0.Notification.ReceiverGroups abc \
    ...
    --Template.AlertDetailRules.0.Rules.0.Annotations.0.Name abc \
    --Template.AlertDetailRules.0.Rules.0.Annotations.0.Value abc \
    --Template.AlertDetailRules.0.Rules.0.RuleState 0 \
    --Template.AlertDetailRules.0.UpdatedAt abc \
    --Template.AlertDetailRules.0.ClusterId abc \
    --Template.TargetsTotal 0
```
