...
```
tccli wedata CreateScriptsImportTasksDs --cli-unfold-argument  \
    --Task.TaskId abc \
    ...
    --Task.DependencyConfigList.0.ParentTask.SelfDepend 0 \
    ...
    --Task.DependencyConfigList.0.SonTask.SelfDepend 0 \
    ...
    --Task.Params.0.Transform abc \
    --Task.Params.0.TransformArgs abc \
    ...
    --Task.LinkId abc \
    --Task.UserFileId abc \
    --EntityDTOList.0.TaskId abc \
    --EntityDTOList.0.Id abc \
    --EntityDTOList.0.TaskName abc \
    --EntityDTOList.0.Name abc \
    --EntityDTOList.0.TaskType abc \
    --EntityDTOList.0.Type abc \
    --EntityDTOList.0.RunUrl abc \
    --EntityDTOList.0.RunReqParams abc \
    --EntityDTOList.0.StopUrl abc \
    --EntityDTOList.0.StopReqParams abc \
    --EntityDTOList.0.StateMonitorUrl abc \
    --EntityDTOList.0.RunLogUrl abc \
    --EntityDTOList.0.LogDownloadUrl abc \
    --EntityDTOList.0.MarkUrl abc \
    --EntityDTOList.0.SourceCluster abc \
    --EntityDTOList.0.SourceService abc \
    --EntityDTOList.0.SourceServer abc \
    --EntityDTOList.0.SqlFileName abc \
    --EntityDTOList.0.DbType abc \
    --EntityDTOList.0.Engine abc \
    --EntityDTOList.0.TypeId 1 \
    --EntityDTOList.0.FileName abc \
    --EntityDTOList.0.Bucket abc \
    --EntityDTOList.0.Region abc \
    --EntityDTOList.0.ExtraInfo abc \
    --EntityDTOList.0.UserFileId abc \
    --ProjectId abc
```
