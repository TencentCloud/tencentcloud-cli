...
```
tccli dlc DescribeTrainingJobSpec --cli-unfold-argument  \
    --SpecId raytrain-spec-thjiim-4py9
```
...
```
{
    "Response": {
        "Spec": {
            ...
            "SpecId": "raytrain-spec-thjiim-4py9",
            "SpecName": "cus04",
            "UpdateTime": 1782983038773
        },
        "RequestId": "429b510b-d079-4071-81a6-a4aebd72ce65"
    }
}
```
