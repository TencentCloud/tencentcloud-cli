**Example 1: Searching in game session list - creationTimeMillis filter**

This example shows you how to search for a game session by creation time.
...
**Example 2: Searching in game session list - complex filter expression**
...
**Example 3: Searching in game session list - game attribute**

This example shows you how to query the list of game sessions with the filter where the value of the game attribute `Key-2aa06135-7d54-11ea-a9c1-3464a91513` is `Value-2aa06136-7d54-11ea-b30b-3464a91513fe`.
Filter expression:
