...
```
tccli thpc InquirePriceCreateWorkspaces --cli-unfold-argument  \
...
```
{
    "Response": {
        "Price": {
            "SpacePrice": {
                "OriginalPrice": 123630.3,
                "DiscountPrice": 123630.3,
                "Discount": 100
            },
            "BandwidthPrice": {
                "UnitPrice": 0.8,
                "DiscountUnitPrice": 0.8,
                "ChargeUnit": "GB",
                "Discount": 100
            }
        },
        "RequestId": "dcec1ad4-54a4-4a49-b754-f65cd7274c82"
    }
}
```
