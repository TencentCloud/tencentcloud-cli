**Example 1: 为saas企业员工用户生成H5批量签署链接**
...
**Example 4: 为渠道子客企业员工用户生成H5批量签署链接**
...
**Example 5: 创建H5批量签署链接，签署完成后跳转到指定地址**
...
**Example 6: 发起合同后，为C端签署人创建H5批量签署链接**
