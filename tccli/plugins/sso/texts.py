...
texts = {
    "zh-CN": {
        ...
        "auth_url_not_configured": "尚未配置 sso url, 使用 tccli configure --url https://your-login-domain.com 来进行配置",
        "configure_succeed": "url 已配置为 '%s', 接下来可以使用 tccli sso login 进行登陆",
        "try_login_with_url": "在浏览器中转到以下链接, 并根据提示完成登录:",
        "account_select_prompt": "请选择您的用户: ",
    ...
    "en-US": {
        ...
        "auth_url_not_configured": "sso url is not configured yet, use tccli configure --url https://your-login-domain.com to configure",
        ...
        "account_select_prompt": "choose your account: ",
